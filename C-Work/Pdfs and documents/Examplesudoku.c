...
void printPuzzle(int puzzle[9][9], bool clear)
{
    if (clear)
    {
...
int isValid(int puzzle[9][9], int row, int col, int value)
{
...
int hasEmptyCell(int puzzle[9][9])
{
    int r, c;
...
void copyPuzzle(int origin[9][9], int copy[9][9])
{
    int r, c;
...
bool fillPuzzle(int puzzle[9][9])
{
    int row, col;
...
bool solveSudoku(int puzzle[9][9], bool visualize)
{
    int row, col;
    for (int i = 0; i < PUZZLE_SIZE * PUZZLE_SIZE; i++)
    {
...
void generatePuzzle(int puzzle[9][9],int difficulty)
{
